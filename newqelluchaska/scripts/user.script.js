...
(function($) {
  ...
  Drupal.behaviors.qelluchaska = {
    attach: function (context) {
      ...
      //Tour prices tables.
      $.ajax({
        url: "/sites/all/themes/newqelluchaska/get.php",
        type:"GET",
...
/* document.addEventListener("DOMContentLoaded",function(event){
  //FUNCION
  var d = document.getElementsByClassName('olark-operator-message');
  if(document.getElementsByClassName('olark-operator-message')) {
